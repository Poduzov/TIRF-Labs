 ...
 * @author user
 */
public class VoltagePanel extends JPanel {
    ...
    public VoltagePanel() {
        ...
        spinner.setModel(new SpinnerNumberModel(0.0d, 0.0d, 5.0d, 0.01d));
        ...
        slider.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                spinner.setValue((double) m.getValue() / 20.0d);
            }
        });
        ...
        spinner.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                slider.setValue((int) Math.round((Double) m.getValue() * 20.0d));
            }
        });
        ...
        pSpinner.add(new JLabel("  V   "), BorderLayout.AFTER_LINE_ENDS);
    ...
    public void updateValue(Double value) {
        slider.setValue((int) Math.round(value * 20.0d));
